...
class EventbriteCrawler:
    ...
    def __init__(self):
        ...
        # Verified place IDs that work with destination search
        self.location_ids = {
            ...
            "seattle": "101730401",
            "boston": "85950361",
            # Note: For other cities, use the official Eventbrite API
            # by setting EVENTBRITE_API_TOKEN in .env
            
            # International Cities (commented out - not verified)
            # "london": "85977501",
            # "paris": "85977502", 
            # "tokyo": "85977503",
            # "sydney": "85977504",
